...
experiment_name=GPU7-Debug-HPO-Diffculty1_Qwen3-8B-$ROLE_NAME-$formatted_time
...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.HPO_epsilon=2e-3 \
    +actor_rollout_ref.actor.HPO_Hvalue=0.85 \
    ...
    +data.response1_length=512 \
    +data.prompt2_length=1024 \
    +data.response2_length=512 \
    +data.prompt3_length=1024 \
    +data.response3_length=512 \
    ...
    trainer.project_name='HPO-debug' \
