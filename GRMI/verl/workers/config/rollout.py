...
#     Configuration for SGLang server when running in server mode
#     """
#     roles: str = "default-is-not-set"
#     max_iter: int = 3
#     role_config_path: Optional[str] = "/userhome/Research_HUB/verl/data_dir/AgentRoles"
#
...
class RolloutConfig(BaseConfig):
    ...
    extra: dict = field(default_factory=dict) # Hanlard 12-11 add

    prompt1_length: int = 1000
    response1_length: int = 2000
    prompt2_length: int = 3200
    response2_length: int = 1000
    prompt3_length: int = 4500
    response3_length: int = 1500
