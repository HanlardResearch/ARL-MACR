...
def compute_reinforce_plus_plus_baseline_outcome_advantage(
    ...
    **kwargs,
    ...
    with torch.no_grad():
        ...
        print(f"core_algos.py: line 470 scores.shape[0]: {scores.shape[0]}")
    return scores, scores
...
def compute_reinforce_plus_plus_outcome_advantage(
    ...
    with torch.no_grad():
        ...
        print(f"core_algos.py: line 616 advantages.shape[0]: {bs}")
        # torch.save(advantages,"/code/tmp/debug/advantages.pt")
