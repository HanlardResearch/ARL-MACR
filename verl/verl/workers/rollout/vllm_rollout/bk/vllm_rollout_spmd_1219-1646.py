...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(
        ...
        agent1_outputs = self._decode_responses_wt_MaxLen(gen_output, max_seq_length - self.config.prompt1_length) # str
        ####################################### <Agent-1> ###################################################
        ...
        agent2_outputs = self._decode_responses_wt_MaxLen(rev_output, max_seq_length - self.config.prompt2_length)  # str
        ####################################### <Agent-2> ###################################################
        ...
        agent3_outputs = self._decode_responses_wt_MaxLen(imp_output,max_seq_length-self.config.prompt3_length)  # str
        ####################################### <Agent-3> ###################################################
