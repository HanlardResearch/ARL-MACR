...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(
        ...
        ####################################### <Agent-2> ###################################################
        # 第2轮 Review Agent
        rev_prompts = [self._build_role_prompt("review", problem, answer) for problem, answer in
        ...
        ####################################### <Agent-3> ###################################################
        # 第3轮 Improve Agent
        imp_prompts = [self._build_role_prompt("improve", problem, answer, feedback) for problem, answer, feedback in
